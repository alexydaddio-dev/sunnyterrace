...
.field input, .field select { width: 100%; padding: 14px 15px; border: 1.5px solid #E8E0D0; border-radius: 14px; font-family: 'DM Sans', -apple-system, sans-serif; font-size: 17px; color: #2C2416; background: #FDFAF4; outline: none; appearance: none; -webkit-appearance: none; transition: border-color 0.15s; }
.field input:focus, .field select:focus { border-color: #C4623A; background: white; }
        ...
        {tab === 2 && (
          <>
            ...
            <div className="field">
              ...
              <input
                type="url"
                placeholder="https://sunnyterrace.vercel.app"
                value={baseUrl}
                onChange={e => { setBaseUrl(e.target.value); saveSettings("st_url", e.target.value); }}
              />
            </div>
            ...
            <div className="field">
              ...
              <input
                type="text"
                placeholder="Sunny Terrace"
                value={propName}
                onChange={e => { setPropName(e.target.value); saveSettings("st_prop", e.target.value); }}
              />
            </div>
            ...
            <div className="field">
              ...
              <input
                ...
                placeholder="Nice"
                value={city}
                onChange={e => { setCity(e.target.value); saveSettings("st_city", e.target.value); }}
              />
            </div>
          </>
        )}
